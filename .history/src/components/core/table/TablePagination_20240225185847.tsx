...
export type TablePaginationProps<T> = {
  className?: string;
  onChange?: (selectedRows: T[]) => void; // Add the 'onChange' property to the type definition
} & Pick<TableCoreProps<T>, keyof TableCoreProps<T> & { onChange?: TableCoreProps<T>['onChange'] }> & {
    paging: PagingState;
