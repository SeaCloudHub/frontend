      ...
      <div className='w-full overflow-y-auto lg:h-full  lg:w-3/4 '>
        ...
        <div className='flex w-full flex-col'>
          <div className='mx-1 mb-4 flex-wrap  rounded-lg border shadow-xl  dark:border-gray-50 lg:flex lg:justify-center  '>
            ...
            <PieChartCore
              data={[
                { value: userStatisticData ? userStatisticData.file_by_type['archive'] || 0 : 0, label: 'Archive' },
                { value: userStatisticData ? userStatisticData.file_by_type['document'] || 0 : 0, label: 'Document' },
                { value: userStatisticData ? userStatisticData.file_by_type['image'] || 0 : 0, label: 'Image' },
                { value: userStatisticData ? userStatisticData.file_by_type['pdf'] || 0 : 0, label: 'PDF' },
                { value: userStatisticData ? userStatisticData.file_by_type['text'] || 0 : 0, label: 'Text' },
                { value: userStatisticData ? userStatisticData.file_by_type['video'] || 0 : 0, label: 'Video' },
